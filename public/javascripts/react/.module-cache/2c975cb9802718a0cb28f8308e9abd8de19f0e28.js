...
var Article = React.createClass({displayName: 'Article',
  ...
  componentDidMount: function() {
    ...
    console.log(this.props.data.title.replace("'", "").replace(/\s/g, ""))
    var canvas = $(this.props.data.title.replace("'", "").replace(/\s/g, ""))[0];
    ...
    return (
      React.DOM.div({className: "article"}, 
        ...
        React.DOM.div({style: articleStyle }, 
          ...
          React.DOM.p(null, React.DOM.span(null, React.DOM.canvas({className:  this.props.data.title}),  this.state.date, " ago")), 
